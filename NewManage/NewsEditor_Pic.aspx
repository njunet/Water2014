<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="NewsEditor_Pic.aspx.cs" Inherits="Maticsoft.Web.Admin.NewsManage.NewsEditor_Pic" %>
        ...
        <div align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td height="25" width="*" style="text-align: left; width: 447px;">
                                                &nbsp;<ce:editor id="FreeTextBox1" runat="server" autoconfigure="Minimal" height="150px"
                                                    showhtmlmode="False" showpreviewmode="False" width="100%"><FRAMESTYLE __designer:dtid="2814754062073869" Width="100%" Height="100%" BackColor="White" CssClass="CuteEditorFrame" BorderWidth="1px" BorderStyle="Solid" BorderColor="#DDDDDD" /></ce:editor></td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                图片预览：</td>
          ...
          <div style="overflow: auto; height: 200px;">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <asp:Button
                            ID="Button1" runat="server" Enabled="False" OnClick="Button1_Click" Text="保存" /><asp:Button
