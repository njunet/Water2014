<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Release.aspx.cs" Inherits="Maticsoft.Web.Admin.Total_Emission.Release" %>
...
<body>
    ...
    <cc1:page01 id="Page011" runat="server" Page_Index="index.aspx" Page_Add="add.aspx" Page_Makesql="AllList.aspx"></cc1:page01>
			...
			<cc1:page02 id="Page021" runat="server" Page_Index="release.aspx"></cc1:page02>
