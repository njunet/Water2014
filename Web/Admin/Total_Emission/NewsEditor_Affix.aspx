<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsEditor_Affix.aspx.cs" Inherits="Maticsoft.Web.Admin.Total_Emission.NewsEditor_Affix" %>
                                ...
                                <td height="22">
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor='<%=Application[Session["Style"].ToString()+"xtable_titlebgcolor"]%>'>
                                        ...
                                        <tr>
                                            ...
                                            <td height="22" style="width: 447px; text-align: left">
                                                <asp:Button ID="Button1" runat="server" Enabled="False" OnClick="Button1_Click" Text="确定" Visible="False" /><asp:Button
