<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Maticsoft.Web.Admin.Total_Emission.Add" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0" bgcolor='<%=Application[Session["Style"].ToString()+"xtable_titlebgcolor"]%>'>
                                        ...
                                        <tr>
                                            ...
                                            <td height="22" style="text-align: left">
                                                ...
                                                是否推荐：<asp:CheckBox ID="chkIsTop" runat="server" Text="是推荐新闻"></asp:CheckBox></td>
                                        </tr>
