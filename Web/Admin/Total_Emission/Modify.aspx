<%@ Page Language="C#"  ValidateRequest="false" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Maticsoft.Web.Admin.Total_Emission.Modify" %>
                ...
                <tr>
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <table cellspacing="0"  cellpadding="5" width="100%" border="1" bordercolordark='<%=Application[Session["Style"].ToString()+"xtable_bordercolordark"]%>'
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td height="25" width="*" style="text-align: left">
                                                <asp:TextBox ID="txtHeading" runat="server" Width="400px" MaxLength="100"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                关键字：</td>
                                        ...
                                        <tr>
                                            <td align="right">
                                                发表时间：</td>
                                            <td height="22" style="text-align: left">
                                                <asp:TextBox ID="txtIssueDate" runat="server" MaxLength="100" Width="200px"></asp:TextBox></td>
                                        </tr>
                                        <tr>
                                            <td align="right">
                                                是否发布：</td>
                                            <td height="22" style="text-align: left">
                                                <asp:CheckBox ID="chkDormancy" runat="server" Text="发布" Checked="True"></asp:CheckBox>&nbsp;
                                                仅内网可访问：<asp:CheckBox ID="chkIsLimited" runat="server" Text="是" />&nbsp;
                                                是否是推荐新闻：<asp:CheckBox ID="chkIsTop" runat="server" Text="发布为推荐" Checked="True"></asp:CheckBox></td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td height="22">
                                  <a href="NewsEditor_Pic.aspx?ArticleId=<%=Request.Params["id"]%>" title="文章图片上传!"  rel="gb_page_fs[]">上传图片</a>
                                 <a href="NewsEditor_Affix.aspx?ArticleId=<%=Request.Params["id"]%>" title="文章附件上传!"  rel="gb_page_fs[]">上传附件</a>
                                 </td>
                            </tr>
