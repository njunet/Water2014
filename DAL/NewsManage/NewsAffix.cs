...
namespace Maticsoft.DAL.NewsManage
{
    ...
    public class NewsAffix
    {
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from NewsAffix");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into T_NewsAffix(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update T_NewsAffix set ");
        ...
        public void Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from T_NewsAffix ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
            parameters[0].Value = Id;
        ...
        public Maticsoft.Model.NewsManage.NewsAffix GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,NewsId,Descrip,LinkUrl,IssueDate from T_NewsAffix ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
            parameters[0].Value = Id;

            Maticsoft.Model.NewsManage.NewsAffix model = new Maticsoft.Model.NewsManage.NewsAffix();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM T_NewsAffix ");
            if (strWhere.Trim() != "")
            {
