...
namespace Maticsoft.DAL
{
	...
	public partial class HIS_MEASURAND_Data
	{
		...
		public bool Add(Maticsoft.Model.HIS_MEASURAND_Data model)
		{
			...
			strSql.Append("id,station_name,river_name,address,posx,posy,systime,CODMn,NH3_N,TP,TN,flow)");
			...
			parameters[2].Value = model.river_name;
			parameters[3].Value = model.address;
			parameters[4].Value = model.posx;
			parameters[5].Value = model.posy;
			parameters[6].Value = model.systime;
			parameters[7].Value = model.CODMn;
			parameters[8].Value = model.NH3_N;
			parameters[9].Value = model.TP;
			parameters[10].Value = model.TN;
			parameters[11].Value = model.flow;
		...
		public Maticsoft.Model.HIS_MEASURAND_Data GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,station_name,river_name,address,posx,posy,systime,CODMn,NH3_N,TP,TN,flow from HIS_MEASURAND_Data ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,station_name,river_name,address,posx,posy,systime,CODMn,NH3_N,TP,TN,flow ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select distinct id,station_name,river_name");
            strSql.Append(" FROM HIS_MEASURAND_Data ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
