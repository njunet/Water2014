<%@ Page Language="C#" MasterPageFile="~/IndexWaterInfo.Master" AutoEventWireup="true" CodeBehind="dataquery_HIS_MEASURAND_AverageFlow_Month.aspx.cs" Inherits="Maticsoft.Web.dataquery_HIS_MEASURAND_AverageFlow_Month" %>
            ...
            <table cellspacing="0" cellpadding="5" width="1200" border="0">                
                <tr>
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        ...
                        <asp:Button ID="buttonToImage" runat="server" OnClick="buttonToImageClick" Text="月均流量图" />                   
                    </td>
                </tr>
            </table>  
</asp:Content>
