<%@ Page Language="C#" MasterPageFile="~/IndexWaterInfo.Master" AutoEventWireup="true" CodeBehind="dataquery_ST_FORECAST_F.aspx.cs" Inherits="Maticsoft.Web.waterInfo.dataquery_ST_FORECAST_F" %>
            ...
            <table cellspacing="0" cellpadding="5" width="1200" border="0">
                <tr>
                    <td height="40" align="left">
                        ...
                        <asp:Label ID="Label2" runat="server">依据时间：</asp:Label>
                        ...
                        <asp:Label ID="Label3" runat="server">发生时间：</asp:Label>
                           <asp:TextBox ID="txtsj" runat="server" BorderStyle="Groove" Width="130px" ToolTip="日期格式:YYYY-MM-DD，双击选择日期" ondblclick="WdatePicker({startDate:'2013-01-23',dateFmt:'yyyy-MM-dd'})" EnableViewState="false" autocomplete="off"></asp:TextBox>
                ...
                <tr>
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            >
                            <Columns> 
                                <asp:BoundField DataField="STCD" HeaderText="测站编码" SortExpression="STCD" /> 
                                <asp:BoundField DataField="YMDH" HeaderText="依据时间" SortExpression="YMDH"  />
                                <asp:BoundField DataField="FYMDH" HeaderText="发生时间" SortExpression="FYMDH"  />        
                                ...
                                <asp:BoundField DataField="UNITNAME" HeaderText="预报单位" SortExpression="UNITNAME"  />
                                <asp:BoundField DataField="PLCD" HeaderText="方案代码" SortExpression="PLCD"  />
