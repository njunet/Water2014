<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMaterial.aspx.cs" Inherits="Maticsoft.Web.Admin.Material.AddMaterial" %>
                        ...
                        <table cellspacing="0" bordercolordark='<%=Application[Session["Style"].ToString()+"xtable_bordercolordark"]%>'
                                    ...
                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                        <tr>
                                            ...
                                            <td style="height: 25px; text-align: left">
                                                <asp:Label ID="Label_materialId" runat="server"></asp:Label></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 202px; height: 25px;">
                                                <div align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; height: 25px;">
                                                <asp:TextBox ID="TextBox_Number" TabIndex="1" runat="server" Width="249px" MaxLength="20"
                                                    BorderStyle="Groove"></asp:TextBox>
                                                </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: left; height: 25px;">
                                                <asp:TextBox ID="TextBox_Address" TabIndex="1" runat="server" Width="249px" MaxLength="50"
                                                    BorderStyle="Groove"></asp:TextBox>
                                                </td>
                                        </tr>
                            ...
                            <tr>
                                <td style="height: 25px">
                                    <div align="center">
                                        <input onclick="CA();" type="checkbox" name="allbox">全选
