...
{
    public partial class testZp2 : System.Web.UI.Page
    {
        ...
        protected void btn_Search_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string Name = this.txtStation.Text.Trim();
            string stationDynamic = this.txtDynamic.Text.Trim();
            ...
            if (Name != "")
            {
                strsql += " and (convert(varchar(20),station_name,20) like'%" + Name + "%')";
            }
            if (stationDynamic != "")
            {
                strsql += " and (convert(varchar(20),dynamic,20) like'%" + stationDynamic + "%')";
            }
