...
{
    public partial class testZp5 : System.Web.UI.Page
    {
        //int PermId_Modify = 56;
        //int PermId_Delete = 57;
        Maticsoft.BLL.HIS_MEASURAND_Data bll = new Maticsoft.BLL.HIS_MEASURAND_Data();
        ...
        protected void btn_Search_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string rivername = this.txtriver.Text.Trim();
            ...
            if (rivername != "")
            {
                strsql += " and (convert(varchar(20),river_name,20) like'%" + rivername + "%')";
            }
            if (time != "")
            {
                strsql += " and (convert(varchar(20),systime,20) like'%" + time + "%')";
            }
