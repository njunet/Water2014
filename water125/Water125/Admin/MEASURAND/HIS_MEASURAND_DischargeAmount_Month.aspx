<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HIS_MEASURAND_DischargeAmount_Month.aspx.cs" Inherits="Maticsoft.Web.Admin.MEASURAND.HIS_MEASURAND_DischargeAmount_Month" %>
                    ...
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns> 
                                ...
                                <asp:BoundField DataField="YYYY_MM" HeaderText="日期" SortExpression="systime"/>        
