<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HIS_MEASURAND_DischargeAmount_Day.aspx.cs" Inherits="Maticsoft.Web.Admin.MEASURAND.HIS_MEASURAND_DischargeAmount_Day" %>
                    ...
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns> 
                                ...
                                <asp:BoundField DataField="date" HeaderText="日期" SortExpression="systime"/>        
