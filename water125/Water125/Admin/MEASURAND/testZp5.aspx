<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="testZp5.aspx.cs" Inherits="Maticsoft.Web.Admin.MEASURAND.testZp5" %>
            ...
            <table cellspacing="0" cellpadding="5" width="1000" border="0">
                <tr>
                    <td height="25" align="left">
                        ...
                        河道名:
                        <asp:TextBox ID="txtriver" runat="server" ToolTip="关键字"></asp:TextBox>&nbsp;
                    ...
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns> 
                                ...
                                <asp:BoundField DataField="address" HeaderText="地址" SortExpression="station_name" /> 
