...
<%@ Page language="c#" Codebehind="Top.aspx.cs" AutoEventWireup="True" Inherits="Water125.Admin.Top" %>
				...
				<tr>
					<td background='<%=Application[Session["Style"].ToString()+"xtopbj_bgimage"]%>'>
						<table width="778" height="102" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td colspan="3">
								    <%--<img src='<%=Application[Session["Style"].ToString()+"xtop1_bgimage"]%>' width="778" height="71" alt="管理系统">--%>
                                <img src="Images/top.gif" width="778" height="71" alt="示范平台"/>
							...
							<tr>
								...
								<td width="486" background='<%=Application[Session["Style"].ToString()+"xtop3_bgimage"]%>'><table width="100%" h eight="31" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td width="9%">&nbsp;</td>
											<td>
											...
											<td>
												<table height="31" border="0" cellpadding="0" cellspacing="0">
													...
													<tr>
														<td><a href="../Default.aspx" target="_top">退出</a></td>
													</tr>
												</table>
											</td>
											<td>
